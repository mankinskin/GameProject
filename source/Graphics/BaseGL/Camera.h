...
namespace camera {
	...
	const Frustum TOP_DOWN_FRUSTUM = Frustum(glm::vec3(0.0, 0.0, -1.0), glm::vec3(0.0, -1.0, 0.0), 70.0f, 1800.0f, 850.0f, 1.0f, 1000.0f);
	...
	const Frustum FIRST_PERSON_FRUSTUM = Frustum(glm::vec3(0.0, 1.0, 0.0), glm::vec3(0.0, 0.0, -1.0), 70.0f, 1800.0f, 850.0f, 1.0f, 1000.0f);
	const LookPolicy FIRST_PERSON_LOOK = LookPolicy(offsetof(Camera, lookAt), offsetof(Camera, mode) + offsetof(CameraMode, frustum) + offsetof(Frustum, up), 1.0f, offsetof(Camera, lookAt), offsetof(Camera, cross), 1.0f, offsetof(Camera, mode) + offsetof(CameraMode, frustum) + offsetof(Frustum, up), glm::vec3(0.0f, 0.0f, 0.0f));
