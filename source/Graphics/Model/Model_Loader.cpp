...
void model::Loader::includeModel(std::string pFilename)
{
...
void model::Loader::loadModelFile(std::string pFilename)
{
	using namespace mesh;
	const aiScene* scene = imp.ReadFile(MODEL_DIR + pFilename, aiProcess_Triangulate | aiProcess_ConvertToLeftHanded	);
