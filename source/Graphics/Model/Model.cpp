...
#include "../Mesh/Mesh.h"
#include "Node.h"
#include "../../World/Physics/Collision.h"
...
void model::setupModels()
{
	...
	node::setPos(sphere_A_node, glm::vec3(0.0f, 0.0f, 0.0f));
	node::setScale(sphere_A_node, glm::vec3(0.8f, 0.8f, 0.8f));
	node::setRotation(sphere_A_node, glm::vec4(0.0f, 1.0f, 0.0f, 1.5f));

	node::setPos(sphere_B_node, glm::vec3(4.0f, 5.0f, 3.0f));
	node::setScale(sphere_B_node, glm::vec3(0.1f, 0.1f, 0.1f));
	node::setRotation(sphere_B_node, glm::vec4(0.0f, 1.0f, 0.0f, 0.5f));
