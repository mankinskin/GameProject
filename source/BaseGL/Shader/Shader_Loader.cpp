...
void shader::Loader::compileModule(size_t pModuleIndex)
{
	...
	glDebug::getGLError("GLERROR: shader::Loader::compileModule()1: at " + mod.fileName);
	...
	glDebug::getGLError("GLERROR: shader::Loader::compileModule(): at " + mod.fileName);
}
...
void shader::Loader::linkProgram(size_t pProgramIndex)
{
	...
	glDebug::getGLError("GLERROR: ShaderProgram::linkProgram(): at " + program.name);
}

void shader::Loader::compileAndLink()
{
	glDebug::getGLError("GLERROR: before compileAndLink():");
