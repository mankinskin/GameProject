...
void gui::initWidgets()
{
	...
	using WindowFrameColors = ColorGroup<9, gl::ColorIt>;
	...
	WindowHeaderColors window_header_colors( { gl::getColor( "grey" ), gl::getColor( "white" ) } );
	...
	WindowFrame::initer_t window_frame_initer( {
	...
	WindowHeader::initer_t window_header_initer( {
