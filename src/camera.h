	...
	LookPolicy(size_t pXRotatorOffset, size_t pXRotationAxisOffset, float pXRotationFactor, size_t pYRotatorOffset,
	  ...
	  : x_rotator_off(pXRotatorOffset)
		, x_rotation_axis_off(pXRotationAxisOffset)
		   , x_rotation_factor(pXRotationFactor)
		   , y_rotator_off(pYRotatorOffset)
		   , y_rotation_axis_off(pYRotationAxisOffset)
		   , y_rotation_factor(pYRotationFactor)
		   , cross_up_off(pCrossUpOffset)
		   , axis_limits(pAxisLimits)
