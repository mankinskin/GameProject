...
void texture::initGUIFBO() {
	...
	quadIndexTexture = get2DTextureID( createTexture2D( gl::getWidth(), gl::getHeight(), GL_R16UI, GL_RED_INTEGER, GL_UNSIGNED_INT, 0 ) );
	fontColorTexture = get2DTextureID( createTexture2D( gl::getWidth(), gl::getHeight(), GL_RGBA8, GL_RGBA, GL_UNSIGNED_BYTE, 0 ) );
